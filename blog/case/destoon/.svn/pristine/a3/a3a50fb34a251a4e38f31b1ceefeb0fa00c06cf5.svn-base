...
<tr>
<td class="tl">商城客服电话</td>
<td><input name="setting[telephone]" type="text" value="<?php echo $telephone;?>" size="20"/></td>
</tr>
<tr>
<td class="tl">商城ICP备案序号</td>
<td><input name="setting[icpno]" type="text" value="<?php echo $icpno;?>" size="20"/></td>
</tr>
<tr>
<td class="tl">雀搜版权信息</td>
<td><textarea name="setting[qs_copyright]" id="qs_copyright" style="width:500px;height:50px;"><?php echo $qs_copyright;?></textarea><br/>支持HTML语法，常用代码：版权&copy; &amp;copy; 空格 &amp;nbsp; 换行  &lt;br/&gt;
</td> 
</tr>
<tr>
<td class="tl">雀搜客服电话</td>
<td><input name="setting[qs_telephone]" type="text" value="<?php echo $qs_telephone;?>" size="20"/></td>
</tr>
<tr>
<td class="tl">雀搜ICP备案序号</td>
<td><input name="setting[qs_icpno]" type="text" value="<?php echo $qs_icpno;?>" size="20"/></td>
</tr>
<tr>
<td class="tl">网站状态</td>
<td>
