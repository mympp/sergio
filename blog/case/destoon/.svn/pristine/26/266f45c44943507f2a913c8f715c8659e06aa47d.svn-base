...
(function($){$.fn.bgIframe=$.fn.bgiframe=function(s){if($.browser.msie&&/6.0/.test(navigator.userAgent)){ie6=1;s=$.extend({top:'auto',left:'auto',width:'auto',height:'auto',opacity:true,src:'javascript:false;'},s||{});var prop=function(n){return n&&n.constructor==Number?n+'px':n;},html='<iframe class="bgiframe"frameborder="0"tabindex="-1"src="'+s.src+'"'+'style="display:block;position:absolute;z-index:-1;'+(s.opacity!==false?'filter:Alpha(Opacity=\'0\');':'')+'top:'+(s.top=='auto'?'expression(((parseInt(this.parentNode.currentStyle.borderTopWidth)||0)*-1)+\'px\')':prop(s.top))+';'+'left:'+(s.left=='auto'?'expression(((parseInt(this.parentNode.currentStyle.borderLeftWidth)||0)*-1)+\'px\')':prop(s.left))+';'+'width:'+(s.width=='auto'?'expression(this.parentNode.offsetWidth+\'px\')':prop(s.width))+';'+'height:'+(s.height=='auto'?'expression(this.parentNode.offsetHeight+\'px\')':prop(s.height))+';'+'"/>';return this.each(function(){if($('> iframe.bgiframe',this).length==0)this.insertBefore(document.createElement(html),this.firstChild);});}return this;};})(jQuery);
...
$("document").ready(function(){
	if(ie6||_g_._get('tie')){
		if(!_g_._get('gv')){
			$("head").append('<link href="http://style.goepe.com/css/1608/17llqt/ie6_llq.css" rel="stylesheet" type="text/css" />');
			$("body").append('<div class="ie6_llq_pnl"><div class="ie6_llq_close"></div><a href="http://www.baidu.com/s?ie=utf-8&wd=%E6%B5%8F%E8%A7%88%E5%99%A8" target="_blank"></a></div>');
			$(".ie6_llq_close").click(function(){$(".ie6_llq_pnl").hide();});
			var tf=function(){_g_.center($(".ie6_llq_pnl"));};
			$(".ie6_llq_pnl").css("position","absolute");$(".ie6_llq_pnl").css("z-index","9999");
			setTimeout(tf,1000)
			$(window).scroll(tf);
		}
	}
...
function g(){
	...
	this.upload = function(id,i) {
		if(this.uplli<2)this.upllw.push([id,i]);
			...
			if(i.watertype||i.source||i.albumid||i.userid){
				var uprm="?frma=1";
				if(i.watertype)uprm=uprm+"&watertype="+i.watertype;
				if(i.source)uprm=uprm+"&source="+i.source;
				if(i.albumid)uprm=uprm+"&albumid="+i.albumid;
				if(i.userid)uprm=uprm+"&userid="+i.userid;
				if(window.location.hostname=="goepe.com")i2.uploader="http://goepe.com/member/ajax_fileupload.php"+uprm;
				else i2.uploader="http://www.goepe.com/member/ajax_fileupload.php"+uprm;
			}
			id.uploadify(i2);
		}
		if(!this.uplli){
			this.uplli=1;
			var ithis=this;
			$.getScript("http://style.goepe.com/common/upll.js",function(){
				setTimeout(function(){
					ithis.uplli=2;
			...
			$("<link>").attr({ rel: "stylesheet",type: "text/css",href:"http://style.goepe.com/common/upll.css"}).appendTo("head");
		}
	}
	this.dlgclose = function() {
		$("#g_dlg_cmt_c",window.parent.document).trigger("click");
	}
	this.dlg = function(id,i) {
		if(this.dlgli<2)this.dlglw.push([id,i]);
		else {
			var i2={w:500,h:300,t:'※※※',f:function(){}};
			if(i.w>=100&&i.w<=1920)i2.w=i.w;
			if(i.h>=50&&i.h<=1280)i2.h=i.h;
			if(i.t)i2.t=i.t;
			if(i.f)i2.f=i.f;
			var n=0;
			if(!$("#g_dlg_cmt").size()){$("body").append('<div id="g_dlg_cmt" style="position:absolute;border:1px solid #CCC;background:#FFF;font-size:12px;"><div id="g_dlg_cmt_t" style="padding-left:10px;height:30px;line-height:30px;background:#EEE;font-weight:700"></div><div id="g_dlg_cmt_c" style="position:absolute;top:0;right:0;width:30px;height:30px;line-height:30px;text-align:center;cursor:pointer;">×</div><iframe id="g_dlg_cmt_w" style="margin:5px" frameborder="0"></iframe></div>');n=1;}
			var d=$("#g_dlg_cmt");
			var t=$("#g_dlg_cmt_t");
			var c=$("#g_dlg_cmt_c");
			var w=$("#g_dlg_cmt_w");
			if(n)c.click(function(){d.hide();i2.f();});
			d.width(i2.w);
			d.height(i2.h);
			w.width(i2.w-10);
			w.height(i2.h-40);
			...
			d.draggable();
			//d.resizable();
			d.css("left",$(document).scrollLeft()+($(window).width()-d.width())/2);
			d.css("top",$(document).scrollTop()+($(window).height()-d.height())/2);
			d.show();
		}
		if(!this.dlgli){
			this.dlgli=1;
			var ithis=this;
			$.getScript("http://style.goepe.com/common/ui/common.js",function(){
				setTimeout(function(){
					ithis.dlgli=2;
					while(ithis.dlglw.length>0){
						var i2=ithis.dlglw.pop();
						if(!i2)break;
						if(!i2[0])break;
						ithis.dlg(i2[0],i2[1]);
					}
	...
	this.center=function(dom){
		dom.css('left',Math.max($("html").scrollLeft(),$("body").scrollLeft())+$(window).width()/2-dom.outerWidth()/2);
		dom.css('top',Math.max($("html").scrollTop(),$("body").scrollTop())+$(window).height()/2-dom.outerHeight()/2);
	}
	this.pnauto = function(){
		if(location.href.indexOf("nofrm=1")!=-1)return false;
		if(window.parent!=window){
			if(_g_.prfc==0||!_g_.prfc.size())_g_.prfc=$(window.parent.document).find("#RightFrame");
			var _p_RightFrame=_g_.prfc;
			if(_p_RightFrame.size()){
				...
				if(1||_g_.staff){
					var h_out2=$("body").height();if(h_out2<800)h_out2=800;
					if(h_out!=h_out2)_p_RightFrame.eq(0).height(h_out2);
					return;
				}
				...
				if(h_out==h_in1&&h_out==h_in2){}
					...
					if(h_in1==h_in2){
						if(_p_RightFrame.eq(0).height()!=h_in1)_p_RightFrame.eq(0).height(h_in1);
					}
					else {
						if(h_in2!=0)_p_RightFrame.eq(0).height(h_in2);
						if(domb[0].scrollHeight!=0)_p_RightFrame.eq(0).height(domb[0].scrollHeight);
						if(parseInt(domb.height())==800)domb.height(100);
					}
				}
				else {
	...
	this.ajax = function(do_action,dataobj,callback_success,callback_error){
		var timeoutms=15000;
	...
	this.u_data_i=null;
	this.u_data_init=function(){
		if(!this.u_data_i){
			var tmpui=document.createElement("INPUT");
			tmpui.type = "hidden";
			tmpui.style.display = "none";
			tmpui.addBehavior ("#default#userData");
			document.body.appendChild(tmpui);
			var expires = new Date();
			expires.setDate(expires.getDate()+365);
			tmpui.expires = expires.toUTCString();
			this.u_data_i=tmpui;
		}
		if(this.u_data_i)return true;
		else return false;
	}
	this.getk=function(k){
		...
		if(this.u_data_init()){
			this.u_data_i.load(window.location.hostname);
			return this.u_data_i.getAttribute(k)
		}
	}
	this.setk=function(k,v){
		if(typeof window.localStorage != 'undefined'){
		...
		if(this.u_data_init()){
			this.u_data_i.load(window.location.hostname);
			this.u_data_i.setAttribute(k, v);
			this.u_data_i.save(window.location.hostname);
			return true;
		}
	}
	this.delk=function(k){
		if(typeof window.localStorage != 'undefined'){
		...
		if(this.u_data_init()){
			this.u_data_i.load(window.location.hostname);
			this.u_data_i.removeAttribute(k);
			this.u_data_i.save(window.location.hostname);
			return true;
		}
	}
	this.prb=function(i){
		var a=0,e=$('body'),d=$(window.parent),f=window.parent.document,b=$("#"+i,f),c=$("html,body",f),p=$(document);
		if(b.css("position").toLowerCase()=="fixed"&&b.offset().left>200)a=1;
		var g=function(){if(!a)b.css("top",c.scrollTop()+d.height()-e.outerHeight()-5);}
		...
		setInterval(function(){
			g();b.css("width",p.width());b.css("height",e.outerHeight());
		},300);
	}
	this.ckeditor=function(c_ka,c_kb,onf){
		if(typeof c_kb["photoinfo"]!="undefined"){
			_g_.ckphotoinfo[c_ka]=c_kb["photoinfo"];
			delete c_kb["photoinfo"];
		}
		if(typeof CKEDITOR!='undefined'){
			CKEDITOR.replace(c_ka,c_kb);
			if(typeof onf=="function")onf();
		}
		else {
			var u="http://style.goepe.com/css/1607/testck4/ckeditor.js";
			var old=0;
			if(_g_.ckeditorold==0){}
			else if(_g_.ckeditorold==1)old=1;
			else {
				if(navigator.userAgent.indexOf("MSIE 6")>-1 || navigator.userAgent.indexOf("MSIE 7")>-1 ||navigator.userAgent.indexOf("MSIE 8")>-1)old=1;
			}
			if(old)u="http://style.goepe.com/common/ckeditor/ckeditor.js";
	...
	this.call = function(_g_c_1) {
		...
		if(typeof this.callm[_g_c_1]=='undefined'){
			...
			var ithis=this;
			$.getScript("http://style.goepe.com/common/gc_"+_g_c_1+".js",function(){
	...
	this.run = function(id,i) {
		var _cfg={};
		_cfg['css']=0;
		if(id=="upload"){
			if(i['id'])i['fileElementId']=i['id'];
			if(!i['success'])return false;
			if(!i['source'])return false;
			if(!i['albumid'])i['albumid']=0;
			if(!i['watermark'])i['watermark']="";
			if(!i['watertype'])i['watertype']="";
			i.url="http://www.goepe.com/member/ajax_fileupload.php?frms=cmup&datatype=json&source="+i['source']+"&albumid="+i['albumid']+"&watermark="+i['watermark']+"&watertype="+i['watertype'];
			if(i['albumid'])i.url+="&userid="+i['userid'];

			if(i['dom']){
				i['dom_o']=i['dom'];
				this.tpid++;
				var tp_id="fupl_"+this.tpid;
				var domii=i['dom'];
				delete i['dom'];
				$("body").append("<input type='file' id='"+tp_id+"' style='position:absolute;top:0;left:0;opacity:0;filter:alpha(opacity=0);z-index:10'>");
				var posf=function(d1,d2){
					i['dom_o']=d2;
					d1.css("left",d2.offset().left);
					d1.css("top",d2.offset().top);
					d1.css("width",d2.outerWidth());
					d1.css("height",d2.outerHeight());
					d1.show();
				}
				domii.each(function(){
				...
				$("#"+tp_id).change(function(){
					if($(this).val()){
						var i2={};for(var ii in i)i2[ii]=i[ii];
						_g_.run("upload",i2);
						console.log(i);
						console.log(i2);
					}
				});
				$("#"+tp_id).bind("propertychange",function(){
					if($(this).val()){
						var i2={};for(var ii in i)i2[ii]=i[ii];
						_g_.run("upload",i2);
					}
				});
				$("#"+tp_id).mouseleave(function(){
					$("#"+tp_id).hide();
				});
				return false;
			}
		}
		if(typeof this.runi[id]=='undefined'){
			this.runi[id]=0;
			this.runw[id]=[];
		}
		if(this.runi[id]<2)this.runw[id].push(i);
		else {
			if(id=="upload")$.ajaxFileUpload(i);
		}
		if(!this.runi[id]){
			this.runi[id]=1;
			var ithis=this;
			$.getScript("http://style.goepe.com/common/run_"+id+".js",function(){
				ithis.runi[id]=2;
				setTimeout(function(){
					while(ithis.runw[id].length>0){
						var i2=ithis.runw[id].pop();
						if(!i2)break;
						ithis.run(id,i2);
					}
				},500);
			});
			if(_cfg['css'])$("<link>").attr({ rel: "stylesheet",type: "text/css",href:"http://style.goepe.com/common/run_"+id+".css"}).appendTo("head");
		}
	}
}
var _g_ = new g();
	...
	$("[fastyu_uid]").each(function(){
		if(!$(this).attr('fy_talk')){
			...
			if($(this).hasClass('smfastyu_online')||$(this).hasClass('smfastyu_offline')||$(this).hasClass('smfastyu_onlinem')){
				$(this).find("a").attr("href","http://www.goepe.com/chat/?initchatuid="+$(this).attr("fastyu_uid"));
				$(this).find("a").attr("target","_blank");
			}
		}
	});
}
if(window==window.parent&&location.href.indexOf("/member/")==-1)$("html").css("height","101%");

var CSSJS="http://style.goepe.com/";
$(document).ready(function(){
	$(window).focus(function(){_focus=1;});
	$(window).blur(function(){_focus--;});
	if(window!=window.parent){
		if(location.href.indexOf('/dlg_')==-1&&top.location.href.indexOf('?testpnauto=1')==-1){
		...
		if(tp_dm.size()==1){
			var tp_p="http://www.goepe.com/member/";
	...
	$("[qqzh]").each(function(){
		...
		$(this).html("<img border=0 src='http://wpa.qq.com/pa?p=1:"+$(this).attr('qqzh')+":10' alt=在线客服>");
	});
		...
		$(window).unload(function(){
			...
			$("a").each(function(){
				...
				if(t_y>=_yarea[0]&&t_y<=_yarea[1]){
					...
					var ispro=1;
					if(t_href.substr(0,7)=="http://"&&t_href.indexOf('.goepe.com')!=-1&&t_href.indexOf('/about/')==-1&&t_href.indexOf('://hbh.goepe.com')==-1){
	...
	$("img").each(function(){
		...
		if(tp_src&&tp_src.indexOf('http://wpa.qq.com/pa')!='-1'){
			var tp_img=new Image();
			tp_img.src=tp_src;
			if(!tp_img.width)$(this).attr('src',"http://style.goepe.com/common/counseling_style_51.png");
		}
	});
	$("[mkpnlid]").each(function(){var mkpnlid=$(this).attr("mkpnlid");if(!$(this).attr("mkpnlid_")){$("[mkpnlid='"+mkpnlid+"']").attr("mkpnlid_","1");$.getScript("http://style.goepe.com/common/pnl/"+mkpnlid+".js",function(){});}});
});
...
function ajaxurl(gp_item,action,more){
	...
	if(tp_host=="member.goepe.com")tp_host="member.goepe.com/member";
	return "http://"+tp_host+"/?inajax=1&gp_item="+gp_item+"&action="+action+"&"+more;
}
...
function fastyu_tip(tips){
	...
	if(!tipsdom.size()){
		...
		dom+='<div style="width:250px; height:157px; background:url(http://style.goepe.com/css/1304/08fastyu/images/goepe_fy_messge.png); position:absolute; left:0; top:0;';
		if(ie6)dom+="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://style.goepe.com/css/1304/08fastyu/images/goepe_fy_messge.png',sizingMethod='crop')";
	...
	'      <tr><td width="15" height="27">&nbsp;</td><td><strong>您有新消息!</strong></td></tr>'+
	'      <tr><td colspan="2">&quot;<span class="fastyu_dialog_msg"></span>&quot;</td></tr>'+
	'      <tr><td colspan="2" style="color:#06C">来自：<span class="fastyu_dialog_company"></span></td>'+
	...
	if(tips.id)$("#fy_talkto").attr("href","http://www.goepe.com/chat/?initchatuid="+tips.id);
	...
	if(!fy_onlinenum){
		...
		$("[fastyu_uid]").each(function(){
			if(fy_uidsallnum<=60){
				...
				if(fy_uidsall.indexOf(","+fy_uidn+",")==-1){
					fy_uidsallnum++;
