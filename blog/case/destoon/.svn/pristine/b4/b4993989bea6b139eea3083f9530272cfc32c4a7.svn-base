...
if($DT_MOB['browser'] == 'weixin' && $EXT['weixin']) dheader('https://open.weixin.qq.com/connect/oauth2/authorize?appid='.WX_ID.'&redirect_uri='.urlencode(WX_CALLBACK).'&response_type=code&scope=snsapi_userinfo#wechat_redirect');
$_SESSION['referer']="1".$_SERVER['HTTP_REFERER'];
?>
<html>
<head>
