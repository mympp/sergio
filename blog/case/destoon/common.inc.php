...
define('QUESOU_PASSPORT_URL', $CFG['quesou_passport_url']);
...
//自定义变量
$MEDIUM_HOST=$CFG['medium_host'];//微信授权域名
$CODE_HZ=$CFG['code_hz'];//手机验证次数
$QS_DB_NAME=$CFG['qs_db_name'];//雀搜数据名
define("QS_DB_NAME",$CFG['qs_db_name']);
...
//二次开发
$wx_host       = "http://wechat.shopwx.cn/";//微信站点域名
$wx_goods_list = "CrmGoods/get_usergoods";//微信获取自身供应商品列表地址
$add_datum     ="CrmUser/datum";//上传个人资料地址
$crm_host      = "http://www.shopwx.cn/";//CRM网址
$DB_NAME1      = "search.";//雀搜数据库名加‘.’;
//二次开发结束
?>