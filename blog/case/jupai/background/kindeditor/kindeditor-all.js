...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	...
	_each(cssPath, function(i, path) {
		if (path) {
			arr.push('<link type="text/css" rel="stylesheet" href="' + path + '" rel="stylesheet" />');
		}
	});
	if (cssData) {
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			...
			'</style>',
			'<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false&language=' + self.langType + '"></script>',
			'<script>',
			'var map, geocoder;',
			'function initialize() {',
