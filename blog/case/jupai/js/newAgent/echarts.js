...
! function(e) {
    ...
    function i(e, t) {
        ...
        var o = N.waitSeconds;
        return o && e instanceof Array && (E && clearTimeout(E), E = setTimeout(n, 1000 * o)), D(e, t)
    }
    ...
    return t.prototype = {
        ...
        _buildItem: function() {
            ...
            "horizontal" === s.orient ? (i = this._itemGroupLocation.y / this.zr.getHeight() < 0.5 ? "bottom" : "top", n = this._itemGroupLocation.x / this.zr.getWidth() < 0.5 ? "left" : "right", o = this._itemGroupLocation.y / this.zr.getHeight() < 0.5 ? "top" : "bottom") : i = this._itemGroupLocation.x / this.zr.getWidth() < 0.5 ? "right" : "left", this._iconShapeMap = {};
        ...
        _getItemShapeByType: function(e, t, i, n, a, o, r) {
            ...
            switch (o) {
                ...
                case "k":
                    ...
                    break;
                case "image":
                    d.style.iconType = "image", d.style.image = s, "#ccc" === a && (d.style.opacity = 0.5)
            }
            return d
        },
    ...
    return n.inherits(t, i), t.prototype._start = function(e, t) {
        for (var i = n.merge(this.options, {
            ...
            var V = -Math.ceil(1000 * Math.random()),
    ...
    return n.inherits(t, i), t.prototype._start = function(e, t) {
        ...
        for (var h = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), c = s.x, m = s.y, p = s.r0 + 6, u = s.r - 6, V = s.color, U = a.lift(V, 0.1), g = new o({
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : ! function() {
        ...
        function g(e, t) {
            ...
            var a = parseFloat(t.currentStyle.fontSize),
                o = parseFloat(e.size);
            return i.size = "number" == typeof e.size ? e.size : -1 != e.size.indexOf("px") ? o : -1 != e.size.indexOf("em") ? a * o : -1 != e.size.indexOf("%") ? a / 100 * o : -1 != e.size.indexOf("pt") ? o / 0.75 : a, i
        }
            ...
            if (a instanceof W) {
                ...
                if ("gradient" == a.type_) {
                    var p = a.x0_ / o,
                        ...
                        b = y.x - f.x,
                        _ = y.y - f.y;
                    h = 180 * Math.atan2(b, _) / Math.PI, 0 > h && (h += 360), 0.000001 > h && (h = 0)
                } else {
    ...
    function t(e) {
        this._targetPool = e.target || {}, this._targetPool instanceof Array || (this._targetPool = [this._targetPool]), this._life = e.life || 1000, this._delay = e.delay || 0, this._startTime = (new Date).getTime() + this._delay, this._endTime = this._startTime + 1000 * this._life, this.loop = "undefined" == typeof e.loop ? !1 : e.loop, this.gap = e.gap || 0, this.easing = e.easing || "Linear", this.onframe = e.onframe, this.ondestroy = e.ondestroy, this.onrestart = e.onrestart
    }
    var i = e("./easing");
    return t.prototype = {
        step: function(e) {
    ...
    var e = {
        ...
        ElasticInOut: function(e) {
            var t, i = 0.1,
                n = 0.4;
            return 0 === e ? 0 : 1 === e ? 1 : (!i || 1 > i ? (i = 1, t = n / 4) : t = n * Math.asin(1 / i) / (2 * Math.PI), (e *= 2) < 1 ? -0.5 * i * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e - t) * Math.PI / n) : i * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e - t) * Math.PI / n) * 0.5 + 1)
        },
        BackIn: function(e) {
            var t = 1.70158;
            return e * e * ((t + 1) * e - t)
        ...
        BounceInOut: function(t) {
            return 0.5 > t ? 0.5 * e.BounceIn(2 * t) : 0.5 * e.BounceOut(2 * t - 1) + 0.5
        }
    };
    return e
                ...
                if (t = o[e[p]], n = t.name, this._sIndex2ShapeMap[e[p]] = this._sIndex2ShapeMap[e[p]] || this.query(t, "symbol") || this._symbol[p % this._symbol.length], d) {
                    if (this.selectedMap[n] = d.isSelected(n), this._sIndex2ColorMap[e[p]] = d.getColor(n), a = d.getItemShape(n)) {
                        ...
                        if (this.type == h.CHART_TYPE_LINE) {
                            ...
                            if (t.itemStyle.normal.barBorderWidth > 0) {
    ...
    return t.prototype = {
        ...
        buildPath: function(e, t) {
            var i = t.pointList,
                n = i.length;
            if (0 !== n) {
                for (var a, o, r, s, l, h = 10000, d = Math.ceil(n / h), c = i[0] instanceof Array, m = t.size ? t.size : 2, p = m, u = m / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
        ...
        buildPath: function(e, t) {
            ...
            if (!(n.length < 2)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    if ("spline" === t.smooth && (n = i(n), o = n.length), t.lineType && "solid" != t.lineType) {
    ...
    function l(t, i, n, a, o) {
        var r = e("zrender/shape/Polygon").prototype.getRect(n.style),
            s = r.x + r.width / 2,
            l = r.y + r.height / 2;
        n.scale = [0.1, 0.1, s, l], t.addShape(n), n.__animating = !0, t.animate(n.id, "").when(a, {
            scale: [1, 1, s, l]
        }).done(function() {
            n.__animating = !1
        }).start(o)
    ...
    function c(e, t, i, a, o, r) {
        if (i.style._x = i.style.x, i.style._y = i.style.y, i.style._width = i.style.width, i.style._height = i.style.height, t) {
            ...
            var s = i._x || 0,
                l = i._y || 0;
            i.scale = [0.01, 0.01, s, l], e.addShape(i), i.__animating = !0, e.animate(i.id, "").delay(r).when(a, {
                scale: [1, 1, s, l]
            }).done(function() {
                i.__animating = !1
            }).start(o || "QuinticOut")
        ...
        buildPath: function(e, t) {
            ...
            if (!(o.length < 2)) {
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    if ("spline" === t.smooth && (o = i(o, !0)), t.lineType && "solid" != t.lineType) {
                        if ("dashed" == t.lineType || "dotted" == t.lineType) {
    ...
    return t.prototype = {
        ...
        _calculSum: function(e, t) {
            ...
            if (this.series[t].stack) {
                ...
                if (e[a] = e[a] || [], this.series[t].type != r.CHART_TYPE_EVENTRIVER) {
        ...
        _reformTimeValue: function() {
            ...
            switch (i) {
                ...
                case "year":
                    ...
                    break;
                default:
                    7200000 >= n ? a = (Math.floor(this._min / n) + 1) * n : (a = s.getNewDate(this._min - -n), a.setHours(6 * Math.round(a.getHours() / 6)), a.setMinutes(0), a.setSeconds(0))
            }
    ...
    function e(e, t, i) {
        ...
        return null == o && (o = "year", n = 31708800000, a = Math.ceil(t / n) * n - Math.floor(e / n) * n, r = Math.round(a / (i - 1) / n) * n), {
            formatter: o,
            gapValue: r
        }
    }
    ...
    function f(e, t, i) {
        ...
        S(t / s) < 0.000001 && (t = 0), S(e / s) < 0.000001 && (e = 0);
        var l, h, d, c = [
                [5, 10],
                [10, 2],
                [50, 10],
