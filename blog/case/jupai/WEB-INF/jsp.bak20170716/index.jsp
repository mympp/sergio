...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/bootstrap.min.css?v=3.3.6" />
    <link type="text/css" rel="stylesheet" href="css/animate.css" />
    <link type="text/css" rel="stylesheet" href="css/style.css?v=4.1.0" />
</head>
...
<body class="fixed-sidebar full-height-layout gray-bg">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <div class="littlebox">
                        ...
                        <li>
                            <a class="J_menuItem" href="boxcollectlist.html"><i class="fa fa-magic"></i> <span class="nav-label icon10">数据查看（开发中）</span></a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="datashow.html"><i class="fa fa-magic"></i> <span class="nav-label icon10">画像查询（开发中）</span></a>
                        </li>
                    </div>
                    <div class="littlebox">
                        <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
    ...
    <!-- 自定义js -->
    <script type="text/javascript" src="js/hAdmin.js?v=4.1.0"></script>
