$(function() {
	...
	function play(preIndex, currentIndex) {
		$('.slider-panel').stop(false,true).eq(preIndex).fadeOut(500)
			.parent().children().eq(currentIndex).fadeIn(1000);
		$('.slider-item').stop(true,true).removeClass('slider-item-selected');
		$('.slider-item').stop(true,true).eq(currentIndex).addClass('slider-item-selected');
	}
